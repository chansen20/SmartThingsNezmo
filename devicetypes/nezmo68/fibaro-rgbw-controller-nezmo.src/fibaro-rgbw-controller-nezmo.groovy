 ...
 *
 *  Version: 0.05 (2018-02-19) - Updated by Nezmo to move color selector from main tile (to avoid ST mobile app crash and standardize some UI elements.
 *
 *  Source: https://github.com/codersaur/SmartThings/tree/master/devices/fibaro-rgbw-controller
 *
 *  Author: David Lomas (codersaur), updated by Nezmo (Nezmo68)
 *
 ...
 **/
metadata {
    definition (name: "Fibaro RGBW Controller - Nezmo", namespace: "Nezmo68", author: "Nezmo") {
        capability "Actuator"
        capability "Switch"
    ...
    tiles (scale: 2){
        ...
        // Power
        standardTile("powerRefresh", "device.powerRefresh", height: 1, width: 1) {
            state "default", label: "Refresh", action: "refresh.refresh", icon: "st.secondary.refresh-icon"
        }
        valueTile("powerLabel", "device.power", decoration: "flat", height: 1, width: 3) {
        ...
        // Energy:
        standardTile("lastResetIcon", "device.lastResetIcon", height: 1, width: 1) {
            state "default", label: "Reset", action: "reset", icon: "st.secondary.refresh-icon"
        }
        valueTile("lastReset", "device.lastReset", decoration: "flat", height: 1, width: 3) {
            state "default", label:'Since: ${currentValue}'
        }
        valueTile("energy", "device.energy", decoration: "flat", height: 1, width: 2) {
            state "default", label:'${currentValue} kWh'
        }

        // Programs:
        standardTile("fireplace", "device.activeProgram", height: 2, width: 2, inactiveLabel: false, canChangeIcon: false) {
        ...
        standardTile("storm", "device.activeProgram", height: 2, width: 2, inactiveLabel: false, canChangeIcon: false) {
        ...
        standardTile("deepFade", "device.activeProgram", height: 2, width: 2, inactiveLabel: false, canChangeIcon: false) {
        ...
        standardTile("liteFade", "device.activeProgram", height: 2, width: 2, inactiveLabel: false, canChangeIcon: false) {
        ...
        standardTile("police", "device.activeProgram", height: 2, width: 2, inactiveLabel: false, canChangeIcon: false) {
        ...
        // Colour Shortcuts:
        standardTile("red", "device.colorName", height: 2, width: 2, inactiveLabel: false, canChangeIcon: false) {
        ...
        standardTile("green", "device.colorName", height: 2, width: 2, inactiveLabel: false, canChangeIcon: false) {
        ...
        standardTile("blue", "device.colorName", height: 2, width: 2, inactiveLabel: false, canChangeIcon: false) {
        ...
        standardTile("cyan", "device.colorName", height: 2, width: 2, inactiveLabel: false, canChangeIcon: false) {
        ...
        standardTile("magenta", "device.colorName", height: 2, width: 2, inactiveLabel: false, canChangeIcon: false) {
        ...
        standardTile("orange", "device.colorName", height: 2, width: 2, inactiveLabel: false, canChangeIcon: false) {
        ...
        standardTile("purple", "device.colorName", height: 2, width: 2, inactiveLabel: false, canChangeIcon: false) {
        ...
        standardTile("yellow", "device.colorName", height: 2, width: 2, inactiveLabel: false, canChangeIcon: false) {
        ...
        standardTile("pink", "device.colorName", height: 2, width: 2, inactiveLabel: false, canChangeIcon: false) {
        ...
        standardTile("refresh", "device.switch", decoration: "flat", inactiveLabel: false, width: 2, height: 2) {
            state "default", label:"", action:"refresh.refresh", icon:"st.secondary.refresh"
        }
        standardTile("test", "device.switch", width: 2, height: 2) {
        ...
        details([
            ...
            // Energy and Power:
            "powerRefresh", "powerLabel", "power", 
            "lastResetIcon", "lastReset", "energy",

            // Built-in Program Shortcuts (these only work if the channels are RGBW):
            "fireplace", "storm", "police", "liteFade", "refresh", "deepFade",
    ...
    preferences {
        ...
        section { // AGGREGATE SWITCH/LEVEL:
            ...
            input name: "configAggregateSwitchMode", type: "enum", defaultValue: "OUT", required: true, displayDuringSetup: false,
                title: "Calculate Aggregate 'switch' value from:\n[Default: RBGW/OUT Channels Only]",
            ...
            input name: "configAggregateLevelMode", type: "enum", defaultValue: "OUT", required: true, displayDuringSetup: false,
                title: "Calculate Aggregate 'level' value from:\n[Default: RBGW/OUT Channels Only]",
                options: ["OUT" : "RBGW/OUT Channels Only",
                          "IN" : "IN Channels Only",
                          "ALL" : "All Channels"]
